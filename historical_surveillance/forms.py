...
class SpecialEdForms1(forms.ModelForm):
    class Meta:
        ...
        fields = ['created_by', 'school', 'academic_year', 'name_of_principal', 'management',
                  'ownership', 'male_enrollment', 'female_enrollment', 'total_enrollment', 'number_of_teaching_staff',
                  'number_of_teaching_staff', 'type_of_school', 'playing_field']


class SpecialEdForms2(forms.ModelForm):
    class Meta:
        model = SpecialEdQuest
        fields = ['number_of_classes', 'number_of_classrooms', 'number_of_halls',
                  'number_of_single_classes_in_single_classrooms',
                  'number_of_classes_sharing_classrooms', 'number_of_classes_in_hall_type_space',
...
class SpecialEdForms3(forms.ModelForm):
    class Meta:
        model = SpecialEdQuest
        fields = ['itinerant_enrollment', 'resource_room_enrollment', 'home_based_enrollment']


class SpecialEdForms4(forms.ModelForm):
    class Meta:
        model = SpecialEdQuest
        fields = ['number_of_male_students_using_glasses', 'number_of_female_students_using_glasses',
                  'number_of_male_students_using_hearing_aids', 'number_of_female_students_using_hearing_aids',
                  'number_of_male_students_using_wheel_chair', 'number_of_female_students_using_wheel_chair',
                  'number_of_male_students_using_crutches', 'number_of_female_students_using_crutches',
                  'number_of_male_students_using_walkers', 'number_of_female_students_using_walkers',
