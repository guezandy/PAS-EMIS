...
urlpatterns = [
    ...
    path('update_enrollment/<int:code>', views.update_enrollment, name='update-enrollment'),

    # for the enrollment/capacity page
    path('enroll_class', views.enroll_class, name='enroll_class'),

    # to update the enrollment / capacity
    path('update_enroll_class/<int:code>', views.update_enroll_class, name='update-enroll-class'),
    ...
    path('national_gender_enrollment', views.nationalgenderenrollment, name='national_gender_enrollment'),
    path('update_national_gender/<int:code>', views.update_national_gender, name='update-national-gender'),

    # for the national education census.
    path('national_education_census', views.national_education_census, name='national_education_census'),
    path('update_national_census/<int:code>', views.update_national_census, name='update-national-census'),

    # for the national expenditure
    path('national_education_expenditure', views.national_education_expenditure, name='national_education_expenditure'),
    path('update_national_expenditure/<int:code>', views.update_national_expenditure, name='update-national-expenditure'),

    # for the national student teacher ratio
    path('national_teacher_ratio', views.national_teacher_ratio, name='national_teacher_ratio'),
    path('update_national_teacher_ratio/<int:code>', views.update_national_teacher_ratio, name='update-national-teacher-ratio'),
