...
class PrimaryPerformance(models.Model):
    ...
    repeaters = models.IntegerField(max_length=30, null=True)
    feeding_program = models.IntegerField(max_length=30, null=True)
    total_bursaries = models.IntegerField(max_length=30, null=True)
    girls = models.IntegerField(max_length=30, null=True)
    primary_enrollment = models.IntegerField(max_length=30, null=True)
    teachers = models.IntegerField(max_length=30, null=True)
    trained_teachers = models.IntegerField(max_length=30, null=True)
