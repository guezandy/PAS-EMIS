    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_of_school', models.CharField(choices=[('public primary', 'Public Primary'), ('public secondary', 'Public Secondary'), ('private primary', 'Private Primary'), ('private secondary', 'Private Secondary'), ('other', 'Other')], max_length=50)),
                ('updated_at', models.DateField(auto_now_add=True)),
                ('updated_by', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_of_school', models.CharField(choices=[('public primary', 'Public Primary'), ('public secondary', 'Public Secondary'), ('private primary', 'Private Primary'), ('private secondary', 'Private Secondary'), ('other', 'Other')], default=None, max_length=50)),
