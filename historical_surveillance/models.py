...
GRADE_CHOICES = [('grade k', 'Grade k'), ('grade 1', 'Grade 1'), ('grade 2', 'Grade 2'), ('grade 3', 'Grade 3'),
                 ...
                 ('form 5', 'Form 5'), ('form 6 L1', 'Form 6 L1'), ('form 6 L2', 'Form 6 L2')]

CATEGORY_CHOICES = [('public primary', 'Public Primary'),
...
MANAGEMENT_CHOICES = [('ministry of education', 'Ministry of Education'),
                      ('board/council', 'Board / Council'),
                      ('others', 'Others')]
OWNERSHIP_CHOICES = [('government', 'Government'),
                     ('private', 'Private'),
                     ('denominational', 'Denominational')]
TYPE_OF_SCHOOL_CHOICES = [('hearing impaired', 'Hearing Impaired'),
...
PLAYING_FIELD_CHOICES = [('community owned', 'Community Owned'),
...
class Enrollment(models.Model):
    ...
    category_of_school = models.CharField(max_length=50, choices=CATEGORY_CHOICES, default=None)
