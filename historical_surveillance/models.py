...
class PrimaryPerformance(models.Model):
    ...
    repeaters = models.IntegerField(null=True)
    feeding_program = models.IntegerField(null=True)
    total_bursaries = models.IntegerField(null=True)
    girls = models.IntegerField(null=True)
    primary_enrollment = models.IntegerField(null=True)
    teachers = models.IntegerField(null=True)
    trained_teachers = models.IntegerField(null=True)
