...
class PrimaryPerformance(models.Model):
    ...
    repeaters = models.CharField(max_length=30, null=True)
    feeding_program = models.CharField(max_length=30, null=True)
    total_bursaries = models.CharField(max_length=30, null=True)
    girls = models.CharField(max_length=30, null=True)
    primary_enrollment = models.CharField(max_length=30, null=True)
    teachers = models.CharField(max_length=30, null=True)
    trained_teachers = models.CharField(max_length=30, null=True)
